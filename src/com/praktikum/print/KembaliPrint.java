...
public class KembaliPrint extends PrintDefault {
	protected List<KembaliPM> pm=new ArrayList<KembaliPM>();
	protected String title="";
	public KembaliPrint(JPanel panel) {
		super(panel);
	...
	public void buildColumn() {
		...
		reportChild.addColumn(buildColumn("start",App.getT("End") , 100));
		reportChild.addColumn(buildColumn("end",App.getT("Kembali") , 100));
		reportChild.addColumn(buildColumn("jml",App.getT("Jumlah") , 30));
		reportChild.addColumn(buildColumn("harga",App.getT("Denda") , 30));
	...
	public List<KembaliPM> getPm() {
		return pm;
	}


	public void setPm(List<KembaliPM> pm) {
		this.pm = pm;
	}
