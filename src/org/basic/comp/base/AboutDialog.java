...
public class AboutDialog {
	...
	private void initComponent() {
		...
		ketLabel = new JLabel(LAbout.KET);
	...
	public void buildComponent() {
		...
		builder.append("Application Name :", new JLabel(LAbout.NAMA));
		builder.append("Version :", new JLabel(LAbout.VERSI));
		builder.append("Powered By :", new JLabel(LAbout.POWERED));
